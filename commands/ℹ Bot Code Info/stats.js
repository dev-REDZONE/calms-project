...
module.exports = {
  ...
  execute: async (client, message, args) => {
    ...
    const embed = new Discord.MessageEmbed()
      ...
      .addField(`• Link Bot:`, `[Invite](https://discord.com/api/oauth2/authorize?client_id=819618331111325706&permissions=8&scope=bot) - [Support](https://discord.gg/fS9BGAYdX9)`, false)
